...
Avec ce graph, on peux clairement constater que les femmes ont effectuer un réel progrès au cours des années. Cependant, nous avons ici un effectif, et nous ne pouvons confirmer donc que le taux des femmes était initialement inférieur et viens ensuite égaler les hommes, nous allons donc comparer les pourcentages par diplome, on ignorera la variable de l'âgge pour ce dernier.
...
Donc grâce à ce graphique, nous pouvons clairement remettre en cause notre hypothèse comme quoi les femmes étaient moins diplomées, elle l'étaient initialement plus et n'ont fais que creuser l'écard au fil des années.